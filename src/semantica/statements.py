"""
Analisador Semantico - Statements
================================

Valida statements e controlo de fluxo no subset Fortran 77.

Responsabilidades:
- Validar atribuicoes, READ/PRINT e chamadas
- Validar labels, GOTO e ciclos DO
- Enforcar contexto de callable (PROGRAM/FUNCTION/SUBROUTINE)
"""
...
class StatementAnalyzer:
    """Valida statements e regras de controlo de fluxo."""
    ...
    def analyze_statement_block(
        ...
        """Valida um bloco de statements no escopo indicado."""
        self._scope = scope
